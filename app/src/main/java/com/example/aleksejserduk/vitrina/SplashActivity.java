...
import com.microfinance.microcrediti.R;
...
public class SplashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (cd.isConnected()) {
            ...
            Toast.makeText(SplashActivity.this, "Требуется подключение к интернету...", Toast.LENGTH_SHORT).show();
    ...
    public void getAnswer() {
        try {
            URL url = new URL("https://fir-b6b74.firebaseio.com/json.json");
